...
class OP300PanTest(models.Model):
    ...
    pan_qc = models.BooleanField(blank=True, null=True)
    pan_qc_homogeneous = models.BooleanField(blank=True, null=True)
    pan_qc_high_contrast = models.DecimalField(max_digits=2, decimal_places=1, blank=True, null=True)
    pan_qc_low_contrast = models.BooleanField(blank=True, null=True)
    pan_qc_round_ball = models.BooleanField(blank=True, null=True)
    pan_qc_distance_white_rods_ball = models.BooleanField(blank=True, null=True)
...
class OP300CefTest(models.Model):
    ...
    cef_qc = models.BooleanField(blank=True, null=True)
    cef_qc_homogeneous = models.BooleanField(blank=True, null=True)
    cef_qc_high_contrast = models.DecimalField(max_digits=2, decimal_places=1, blank=True, null=True)
    cef_qc_low_contrast = models.BooleanField(blank=True, null=True)
...
class OP300CBCTTest(models.Model):
    ...
    cbct_qc = models.BooleanField(blank=True, null=True)
