...
from .views import skeleton_protocols, skeleton_protocols_results, pex, pex_read, history, list_exams, exams, compare_protocols
...
urlpatterns = [
    ...
    path('compare_protocols', compare_protocols, name='sp-compare-protocols'),
